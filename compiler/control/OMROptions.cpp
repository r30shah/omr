...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"disablePREWhenProfiling",            "O\tdisable partial redundancy elimination while profiling",  SET_OPTION_BIT(TR_DisablePREWhenProfiling), "F"},
   ...
   {"traceJProfilingRecompLoopTest",    "L\ttrace trace addition of recompilation trees in loops in profiling method body", TR::Options::traceOptimization, jProfilingRecompLoopTest, 0, "P"},
