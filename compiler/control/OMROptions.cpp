...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"traceJProfilingRecompLoopTest",    "L\ttrace recompilation tests genereation for jProfiling compilations",   TR::Options::traceOptimization, jProfilingRecompLoopTest, 0, "P"},
   {"traceJProfilingValue",             "L\ttrace lowering profiling calls",               TR::Options::traceOptimization, jProfilingValue, 0, "P"},
#endif
