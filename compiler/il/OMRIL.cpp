...
OMR::IL::opCodeForRegisterLoad(TR::DataType dt)
   ...
   if (dt.isVector())
      ...
      switch (dt.getVectorElementType())
         {
         case TR::Int8:   return TR::vsRegLoad;
         case TR::Int16:  return TR::vbRegLoad;
...
OMR::IL::opCodeForRegisterStore(TR::DataType dt)
   ...
   if (dt.isVector())
      ...
      switch (dt.getVectorElementType())
         {
         case TR::Int8:   return TR::vsRegStore;
         case TR::Int16:  return TR::vbRegStore;
