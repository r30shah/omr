...
static const TR::InstOpCode::Mnemonic VectorBinaryArithmeticOpCodesForReg[TR::NumVectorElementTypes+1][NumBinaryArithmeticOps] =
   {
   //  Invalid,       Add,         Sub,         Mul,         Div,          And,         Or,       Xor
   { TR::InstOpCode::bad, TR::InstOpCode::bad,   TR::InstOpCode::bad,   TR::InstOpCode::bad,    TR::InstOpCode::bad,   TR::InstOpCode::bad,  TR::InstOpCode::bad, TR::InstOpCode::bad  }, // NoType
...
static const TR::InstOpCode::Mnemonic VectorBinaryArithmeticOpCodesForMem[TR::NumVectorElementTypes+1][NumBinaryArithmeticOps] =
   {
   //  Invalid,       Add,         Sub,         Mul,         Div,          And,         Or,       Xor
   { TR::InstOpCode::bad, TR::InstOpCode::bad,   TR::InstOpCode::bad,   TR::InstOpCode::bad,    TR::InstOpCode::bad,   TR::InstOpCode::bad,  TR::InstOpCode::bad, TR::InstOpCode::bad  }, // NoType
...
TR::Register* OMR::X86::TreeEvaluator::FloatingPointAndVectorBinaryArithmeticEvaluator(TR::Node* node, TR::CodeGenerator* cg)
   ...
   TR_ASSERT_FATAL(!type.isVector() || type.getVectorLength() == TR::VectorLength128, "Only 128-bit vectors are supported right now\n");
   ...
   if (useRegMemForm)
      ...
      if (operandNode1->getRegister()                               ||
          ...
          type.isVector() ? VectorBinaryArithmeticOpCodesForMem[type.getVectorElementType()][arithmetic] == TR::InstOpCode::bad :
   ...
   TR::InstOpCode::Mnemonic opCode = useRegMemForm ? (type.isVector() ? VectorBinaryArithmeticOpCodesForMem[type.getVectorElementType()][arithmetic] :
                                                                        BinaryArithmeticOpCodesForMem[type][arithmetic]) :
                                                                        (type.isVector() ? VectorBinaryArithmeticOpCodesForReg[type.getVectorElementType()][arithmetic] :
